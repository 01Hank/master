...
@Component
public class CenterContextAware implements ApplicationContextAware {
...
//            }
     ...
     * @return
     */
    public static BaseHandler<GeneratedMessageV3> createHandler(String simpleName) throws IllegalAccessException, InstantiationException {
        Class aClass = factory.get(simpleName);
        return (BaseHandler<GeneratedMessageV3>) aClass.newInstance();
    }
}
